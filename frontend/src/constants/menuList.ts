  ...
  children: [
    {
      ...
      icon: ExternalLink,
      roles: ['admin', 'manager', 'staff'],
      i18nKey: 'menu.outsourcing.dashboard',
    },
    // {
    //   title: '注文管理',
    ...
    //   icon: ClipboardList,
    //   roles: ['admin', 'manager', 'staff'],
    //   i18nKey: 'menu.outsourcing.orders',
    // },
    // {
    //   title: '仕入先管理',
    //   path: '/outsourcing/suppliers',
    //   icon: Building2,
    //   roles: ['admin', 'manager'],
    //   i18nKey: 'menu.outsourcing.suppliers',
    // },
    // {
    //   title: '能力マトリックス',
    //   path: '/outsourcing/capability',
    //   icon: BarChart3,
    //   roles: ['admin', 'manager'],
    //   i18nKey: 'menu.outsourcing.capability',
    // },
    // {
    //   title: 'パフォーマンス管理',
    //   path: '/outsourcing/performance',
    //   icon: TrendingUp,
    //   roles: ['admin', 'manager'],
    //   i18nKey: 'menu.outsourcing.performance',
    // },
    // {
    //   title: '在庫管理',
    //   path: '/outsourcing/inventory',
    //   icon: Boxes,
    //   roles: ['admin', 'manager', 'staff'],
    //   i18nKey: 'menu.outsourcing.inventory',
    // },
    // {
    //   title: '受領検査',
    //   path: '/outsourcing/receiving',
    //   icon: ListChecks,
    //   roles: ['admin', 'manager', 'staff'],
    //   i18nKey: 'menu.outsourcing.receiving',
    // },
    // {
    //   title: '決済コスト',
    ...
    //   icon: DollarSign,
    //   roles: ['admin', 'manager'],
    //   i18nKey: 'menu.outsourcing.settlement',
    // },
    // {
    //   title: '分析レポート',
    //   path: '/outsourcing/analytics',
    //   icon: LineChart,
    //   roles: ['admin', 'manager'],
    //   i18nKey: 'menu.outsourcing.analytics',
    // },
  ],
}
...
export const shippingMenu: MenuItem = {
  ...
  children: [
    ...
    },
    {
      ...
      icon: ClipboardList,
      roles: ['admin', 'manager', 'staff'],
      i18nKey: 'menu.shipping.shipping-list',
    },
    {
      title: '溶接出荷管理',
