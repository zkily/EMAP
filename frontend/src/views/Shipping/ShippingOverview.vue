<template>
  <div class="shipping-overview">
    ...
    >
      <template #header>
        <div class="dialog-header-container">
          <span class="el-dialog__title">報告プレビュー</span>
          <div class="dialog-header-actions">
    ...
    <!-- 分组管理弹窗 -->
    <DestinationGroupManager v-model="showGroupManager" @groups-updated="handleGroupsUpdated" />
  </div>
</template>
...
import { downloadShippingOverviewPDF, downloadShippingReportPDF } from '@/api/shipping/printing'
