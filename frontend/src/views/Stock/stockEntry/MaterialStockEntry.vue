  ...
  <div class="material-stock-page">
    ...
    <el-card class="form-card" shadow="never">
      <div class="form-header">
        ...
        <div class="header-content">
          ...
          <div class="title-section">
            <h2 class="form-title">材料在庫 入出庫登録</h2>
            <p class="form-subtitle">材料在庫の入出庫を管理</p>
          </div>
        </div>
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="90px" class="vertical-form"
        ...
        <div class="form-section">
          ...
          <!-- 材料CD -->
          <el-form-item label="材料" prop="target_cd" class="elegant-form-item">
            <el-select v-model="form.target_cd" filterable placeholder="材料を選択" class="elegant-select">
          ...
          <el-form-item label="保管場所" prop="location_cd" class="elegant-form-item">
            <div class="location-container">
              <el-radio-group v-model="form.location_cd" class="elegant-location-group">
                <el-radio-button v-for="loc in locationOptions" :key="loc.cd" :value="loc.cd"
                  class="elegant-location-btn">
                  {{ loc.name }}
                </el-radio-button>
              </el-radio-group>
            </div>
        ...
        <div class="form-section">
          ...
          <el-form-item label="束本数" prop="base_qty" class="elegant-form-item">
            <div class="base-qty-container">
              <el-input-number v-model="form.base_qty" :min="0" :step="1" class="elegant-input-number base-qty-input"
                placeholder="束あたりの本数" />
    ...
    <el-card v-if="todayLoggedMaterials.length" class="result-card" shadow="never">
      ...
      <div class="table-container">
        <el-table :data="todayLoggedMaterials" stripe class="elegant-table">
