<template>
  ...
  >
      ...
      <div class="dialog-header">
        <div class="header-left">
          ...
          <div class="header-content">
            <h3 class="dialog-title">新規受注追加</h3>
            <p class="dialog-subtitle">新しい受注情報を入力してください</p>
          </div>
        </div>
    ...
    <div class="dialog-content">
      <el-form :model="form" label-width="120px" :rules="rules" ref="formRef" class="modern-form">
        <!-- 日期信息卡片 -->
        ...
        <div class="form-section">
          ...
          <div class="section-content">
            <!-- 第一行：入数和確定箱数 -->
            <el-row :gutter="24" class="input-row">
              <el-col :xs="24" :sm="12" :md="12">
                <el-form-item label="入数" prop="unit_per_box" class="number-form-item">
                  <el-input
                    ...
                    type="text"
                    placeholder="入数を入力"
                    @input="(value) => handleNumericInput(value, 'unit_per_box')"
              ...
              <el-col :xs="24" :sm="12" :md="12">
                <el-form-item label="確定箱数" prop="confirmed_boxes" class="number-form-item">
                  <el-input
            ...
            <el-row class="input-row">
              <el-col :span="24">
                <el-form-item
                  ...
                  class="number-form-item calculated-form-item"
                >
                  <el-input
                    v-model="form.confirmed_units"
                    type="text"
                    placeholder="自動計算 (本)"
                    class="modern-input calculated-field number-input"
                    readonly
                    size="large"
                  />
                </el-form-item>
    ...
    <template #footer>
      <div class="dialog-footer">
        <el-button class="cancel-btn" size="large" @click="visible = false">
          <el-icon><Close /></el-icon>
          キャンセル
        </el-button>
        <el-button
...
const rules = reactive<FormRules>({
  ...
  product_type: [{ required: true, message: '製品タイプを選択してください', trigger: 'change' }],
})
...
const handleDeliveryDateChange = (val: string) => {
  ...
  // 添加额外的属性以确保数据被正确传递
  // @ts-ignore - 添加额外属性用于调试
  form.value._delivery_date_raw = val
}
