...
import LineChart from '@/views/Order/components/LineChart.vue'
import BarChart from '@/views/Order/components/BarChart.vue'
import KpiFilters from '@/views/Order/components/KpiFilters.vue'
import KpiSummaryCards from '@/views/Order/components/KpiSummaryCards.vue'
import AverageUnitPriceChart from '@/views/Order/components/AverageUnitPriceChart.vue'
